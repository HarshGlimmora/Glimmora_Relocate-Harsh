    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          required
          autoComplete="email"
          defaultValue="admin@glimmora.ai"
          className="mt-1.5 w-full rounded-xl border border-ink-200 bg-white px-4 py-2.5 text-[14px] text-ink-900 placeholder:text-ink-400 shadow-sm transition-all focus:outline-none focus:ring-4 focus:border-ink-900 focus:ring-ink-900/15"
        />
      </div>
      <div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-full bg-ink-900 px-5 text-[13.5px] font-semibold text-parchment transition-colors hover:bg-ink-800 disabled:opacity-60 disabled:cursor-wait"
      >
