...
export const metadata: Metadata = {
  title: {
    default: "Glimmora for Partners",
    template: "%s · Glimmora for Partners",
  },
  description: "Sell housing, schools, banking, legal, and local services to relocating professionals across the EU.",
  applicationName: "Glimmora for Partners",
