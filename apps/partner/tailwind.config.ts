...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Partner accent — purple per spec
        plum:     { 50: "#F6F0FA", 100: "#EADDF2", 200: "#D6BBE6", 300: "#BD94D4", 400: "#9E66BB", 500: "#7E42A0", 600: "#6B3E8A", 700: "#512E69", 800: "#371F47", 900: "#1F112A", 950: "#0E0814" },
